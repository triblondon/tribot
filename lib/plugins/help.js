...
module.exports.load = function(bot, options) {
	bot.onMessage(/^(help|hi|hello|hey|wassup|who are you\??)$/, function(msg) {
		...
		var op = "I am "+bot.config.name+".  When you talk to me in a group chat, remember to prefix your message with `@"+bot.config.name+"` or `"+bot.config.name+":`, otherwise I'll stay quiet.  When talking to me privately no prefix is required.\n\nI understand these commands:\n\n"+cmds.join('\n');
		if (msg.room) {
